...
public class ClassManagerImpl extends BshClassManager {
    ...
    public void reloadClasses(String[] classNames)
        ...
        for (int i = 0; i < classNames.length; i++) {
            ...
            BshClassPath.ClassSource classSource = baseClassPath.getClassSource(name);
...
//System.out.println( "defineClass: "+name );
        baseClassPath.setClassSource(name, new BshClassPath.GeneratedClassSource(code));
        try {
