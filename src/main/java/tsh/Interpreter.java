...
public class Interpreter
    ...
    */
    ...
    public Interpreter() {
        ...
        evalOnly = true;
        setu("tsh.evalOnly", Primitive.TRUE);
    }
    ...
    private void initRootSystemObject() {
        ...
        // bsh.system
        setu("tsh.system", sharedObject);
        setu("tsh.shared", sharedObject); // alias

        // bsh.help
        This helpText = new NameSpace(
                bcm, "Bsh Command Help Text").getThis(this);
        setu("tsh.help", helpText);

        // bsh.cwd
        try {
            setu("tsh.cwd", System.getProperty("user.dir"));
        ...
        // bsh.interactive
        setu("tsh.interactive", interactive ? Primitive.TRUE : Primitive.FALSE);
        // bsh.evalOnly
        setu("tsh.evalOnly", evalOnly ? Primitive.TRUE : Primitive.FALSE);
    }
    ...
    public static void main(String[] args) {
        if (args.length > 0) {
            ...
            interpreter.setu("tsh.args", bshArgs);
            try {
                Object result =
	...
	*/
    ...
    public File pathToFile(String fileName)
        ...
        if (!file.isAbsolute()) {
            String cwd = (String) getu("tsh.cwd");
