 ...
 * tsh.Interpreter to interact with your scripts.
 * <p>
 * <p>
...
public class NameSpace implements java.io.Serializable, BshClassManager.Listener, NameSource {
	...
	*/
     ...
     * </p>
     */
    public void setLocalVariableOrProperty(
            String name, Object value, boolean strictJava)
            throws UtilEvalError {
    ...
    protected Variable createVariable(
            String name, Object value, Object mods)
            throws UtilEvalError {
        return createVariable(name, null/*type*/, value, mods);
    }

    protected Variable createVariable(
            String name, Class type, Object value, Object mods)
            throws UtilEvalError {
     ...
     */
    public TshMethod[] getMethods() {
        if (methods == null)
            return new TshMethod[0];
        else
     ...
     * @see #getMethods()
     */
    private TshMethod[] flattenMethodCollection(Enumeration e) {
        Vector v = new Vector();
        while (e.hasMoreElements()) {
            Object o = e.nextElement();
            if (o instanceof TshMethod)
                v.addElement(o);
            else {
                Vector ov = (Vector) o;
        ...
        TshMethod[] bma = new TshMethod[v.size()];
        v.copyInto(bma);
        return bma;
    }
...
// this?
    ...
    */
    ...
    public void setTypedVariable(
        ...
        setTypedVariable(name, type, value, null);
    }
     ...
     */
    public void setTypedVariable(
            String name, Class type, Object value, Object modifiers)
            throws UtilEvalError {
     ...
     */
    public void setMethod(String name, TshMethod method)
            throws UtilEvalError {
        ...
        else if (m instanceof TshMethod) {
            Vector v = new Vector();
            v.addElement(m);
            v.addElement(method);
            methods.put(name, v);
     ...
     */
    public TshMethod getMethod(String name, Class[] sig)
            throws UtilEvalError {
     ...
     *                     be visible.
     * @return the TshMethod or null if not found
     * @see bsh.Primitive
     */
    public TshMethod getMethod(
            String name, Class[] sig, boolean declaredOnly)
            throws UtilEvalError {
        TshMethod method = null;
        ...
        if (method == null && methods != null) {
            ...
            // m contains either TshMethod or Vector of TshMethod
            if (m != null) {
                // unwrap
                TshMethod[] ma;
     ...
     * e.g. importCommands("/bsh/commands") or importCommands("tsh.commands")
     ...
     * script the script is sourced into this namespace and the TshMethod for
     ...
     * @return a TshMethod, Class, or null if no such command is found.
    ...
    protected TshMethod getImportedMethod(String name, Class[] sig)
            throws UtilEvalError {
        // Try object imports
        if (importedObjects != null)
            for (int i = 0; i < importedObjects.size(); i++) {
                ...
                if (method != null)
                    return new TshMethod(method, object);
            }
        ...
        if (importedStatic != null)
            for (int i = 0; i < importedStatic.size(); i++) {
                ...
                if (method != null)
                    return new TshMethod(method, null/*object*/);
            }
    ...
    /**
     * Load a command script from the input stream and find the TshMethod in
	...
	*/
    private TshMethod loadScriptedCommand(
		...
		*/
        ...
        TshMethod meth = getMethod(name, argTypes);
		/*
		if ( meth == null )
    ...
    */
     ...
     * <pre>
     * importClass("tsh.exception.EvalError");
     * importClass("tsh.Interpreter");
	...
	*/
    ...
    boolean attemptSetPropertyValue(String propName,
        ...
        TshMethod m = getMethod(accessorName, classArray);
