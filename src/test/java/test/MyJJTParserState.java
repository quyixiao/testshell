...
class MyJJTParserState {
    ...
    public static void main(String[] args) {
        MyJJTParserState jjtree = new MyJJTParserState();
        BSHTernaryExpression jjtn001 = new BSHTernaryExpression(ParserTreeConstants.JJTTERNARYEXPRESSION);
